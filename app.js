...
const getResponseObject = (dbObject) => {
  return {
...
const directorResponseObject = (dbObject) => {
  return {
    directorId: dbObject.director_id,
...
app.get("/movies/:movieId/", async (request, response) => {
  ...
  response.send(getResponseObject(movie));
});
...
app.get("/directors/", async (request, response) => {
  ...
  response.send(
    directorsArray.map((eachDirector) => directorResponseObject(eachDirector))
  );
});
